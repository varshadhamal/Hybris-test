 ...
 */
package com.hybris.cartridge.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(CartridgeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CartridgeFulfilmentProcessConstants.PARENT_PROCESS);
