 ...
 */
package com.hybris.cartridge.fulfilmentprocess.test.jobs;
...
import com.hybris.cartridge.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = CartridgeFulfilmentProcessConstants.ORDER_PROCESS_NAME;
