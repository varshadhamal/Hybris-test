 ...
 */
package com.hybris.cartridge.test.setup;
...
import com.hybris.cartridge.test.constants.CartridgeTestConstants;
import com.hybris.cartridge.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CartridgeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cartridgetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cartridgetest/import/reviews.impex");
			...
			importImpexFile(context, "/cartridgetest/import/cstickets.impex");
		}
	}
}
