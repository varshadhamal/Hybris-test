...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cartridgestorefront/electronics/en",
						"https://electronics.local:9002/cartridgestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cartridgestorefront/electronics/en",
						"https://electronics.local:9002/cartridgestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cartridgestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/cartridgestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cartridgestorefront/electronics/en",
						"https://electronics.local:9002/cartridgestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cartridgestorefront",
						"https://electronics.local:9002/cartridgestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cartridgestorefront",
						"https://electronics.local:9002/cartridgestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/cartridgestorefront/electronics/en",
						"https://electronics.local:9002/cartridgestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
