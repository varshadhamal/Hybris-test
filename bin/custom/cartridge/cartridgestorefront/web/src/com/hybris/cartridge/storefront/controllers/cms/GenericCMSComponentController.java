 ...
 */
package com.hybris.cartridge.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('cartridgestorefront.generic.cms.component.controller.authorized.group')}")
