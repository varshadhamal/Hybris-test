...
public class PreviewDataModel extends ItemModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(DEVICEORIENTATION);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(DEVICESUPPORT);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(VIEWPORT);
	}
	...
	{
		getPersistenceContext().setPropertyValue(DEVICEORIENTATION, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(DEVICESUPPORT, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(VIEWPORT, value);
	}
