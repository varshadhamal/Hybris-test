...
public class DroolsRuleModel extends AbstractRuleEngineRuleModel
{
	...
	public final static String _TYPECODE = "DroolsRule";
	...
	public final static String _DROOLSKIEBASE2RULE = "DroolsKIEBase2Rule";
	 ...
	 */
	@Deprecated
	public DroolsRuleModel(final String _code, final RuleType _ruleType, final Long _version)
	{
		super();
		setCode(_code);
