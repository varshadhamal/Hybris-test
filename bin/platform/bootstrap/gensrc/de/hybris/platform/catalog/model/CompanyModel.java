...
public class CompanyModel extends UserGroupModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(BILLINGADDRESSES);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(CONTACTADDRESSES);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(SHIPPINGADDRESSES);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(UNLOADINGADDRESSES);
	}
