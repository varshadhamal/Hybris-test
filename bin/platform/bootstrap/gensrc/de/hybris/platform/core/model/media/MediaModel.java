...
public class MediaModel extends AbstractMediaModel
{
	...
	{
		return getPersistenceContext().getPropertyValue(DENIEDPRINCIPALS);
	}
	...
	public String getDownloadURL()
	{
		return getPersistenceContext().getPropertyValue(DOWNLOADURL);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(FOREIGNDATAOWNERS);
	}
	...
	{
		getPersistenceContext().setPropertyValue(DENIEDPRINCIPALS, value);
	}
