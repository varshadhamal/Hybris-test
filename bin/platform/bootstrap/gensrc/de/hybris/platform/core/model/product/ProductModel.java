...
public class ProductModel extends ItemModel
{
	...
	public final static String _FUTURESTOCKPRODUCTRELATION = "FutureStockProductRelation";
	...
	{
		return getPersistenceContext().getPropertyValue(EUROPE1PRICES);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(EUROPE1TAXES);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(SOLRHEROPRODUCTDEFINITIONS);
	}
	...
	{
		return getPersistenceContext().getPropertyValue(UNTYPEDFEATURES);
	}
	...
	{
		getPersistenceContext().setPropertyValue(EUROPE1PRICES, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(EUROPE1TAXES, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(SOLRHEROPRODUCTDEFINITIONS, value);
	}
	...
	{
		getPersistenceContext().setPropertyValue(UNTYPEDFEATURES, value);
	}
