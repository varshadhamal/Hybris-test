...
public class CxSegmentTriggerModel extends CxAbstractTriggerModel
{
	...
	public final static String _TYPECODE = "CxSegmentTrigger";
	 ...
	 * @param _segments initial attribute declared by type <code>CxSegmentTrigger</code> at extension <code>personalizationservices</code>
	 ...
	 */
	@Deprecated
	public CxSegmentTriggerModel(final CatalogVersionModel _catalogVersion, final String _code, final CxGroupingOperator _groupBy, final Collection<CxSegmentModel> _segments, final CxVariationModel _variation)
	{
		super();
	 ...
	 */
	@Deprecated
	public CxSegmentTriggerModel(final CatalogVersionModel _catalogVersion, final String _code, final CxGroupingOperator _groupBy, final ItemModel _owner, final Collection<CxSegmentModel> _segments, final CxVariationModel _variation)
	{
		super();
		setCatalogVersion(_catalogVersion);
		setCode(_code);
