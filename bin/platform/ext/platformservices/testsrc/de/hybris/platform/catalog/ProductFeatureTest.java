...
public class ProductFeatureTest extends ServicelayerTransactionalTest
{
	...
	public void testSimpleCreateProductFeatureModel1() throws JaloGenericCreationException, JaloAbstractTypeException,
	...
	@Test(expected = de.hybris.platform.servicelayer.exceptions.ModelSavingException.class)
	public void testSimpleCreateProductFeatureModel2() throws JaloGenericCreationException, JaloAbstractTypeException,
															  ConsistencyCheckException
	{
		final ProductFeatureModel modelItem = modelService.create(ProductFeatureModel.class);
	...
	@Test
	public void testSimpleCreateProductFeatureModel3() throws JaloGenericCreationException, JaloAbstractTypeException,
															  ConsistencyCheckException
	{
	...
	@Test
	public void testSimpleCreateProductFeatureModel4() throws JaloGenericCreationException, JaloAbstractTypeException,
															  ConsistencyCheckException
	{
		final ProductFeatureModel modelItem = modelService.create(ProductFeatureModel.class);
		modelItem.setProduct(productModel);
