...
public class CatalogVersionServiceTest extends ServicelayerTransactionalTest
{
	...
	public void testGetReadableCatalogVersions()
	{
		...
		assertTrue("readable catalog version should be empty", catalogVersionService.getAllReadableCatalogVersions(user3).isEmpty());
	...
	public void testGetWritableCatalogVersions()
	{
		...
		assertTrue("readable catalog version should be empty", catalogVersionService.getAllWritableCatalogVersions(user3).isEmpty());
