...
public class DefaultClassificationServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	public void shouldProperlyReplaceFeaturesUsingFeatureListFromAnotherProductKeepingSourceUntouched()
	{
		...
		createProductFeatureForProduct(prod1, "fooBar11");
		createProductFeatureForProduct(prod1, "fooBar12");
		createProductFeatureForProduct(prod2, "fooBar21");
		createProductFeatureForProduct(prod2, "fooBar22");
	...
	private void createProductFeatureForProduct(final ProductModel product, final String value)
	{
