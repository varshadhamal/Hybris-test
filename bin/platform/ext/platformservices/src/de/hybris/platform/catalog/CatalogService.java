...
public interface CatalogService
{
	 ...
	 * @deprecated use {@link CatalogVersionService#setSessionCatalogVersion(String, String)} instead.
	 */
	@Deprecated
	 ...
	 * @deprecated Use {@link CatalogVersionService#setSessionCatalogVersions(Collection)}
	 */
	@Deprecated
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>catalogId</code> or <code>catalogVersionName</code> is <code>null</code>
	 * @deprecated Use {@link CatalogVersionService#addSessionCatalogVersion(CatalogVersionModel)}
	 */
	@Deprecated
	 ...
	 * @deprecated Use {@link CatalogVersionService#getSessionCatalogVersions()}
	 */
	@Deprecated
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>catalogId</code> or <code>catalogVersionName</code> is <code>null</code>
	 * @deprecated Use {@link CatalogVersionService#getCatalogVersion(String, String)}
	 */
	@Deprecated
	 ...
	 * @deprecated Use {@link #getCatalogForId(String)} instead.
	 */
	@Deprecated
	 ...
	 *            <code>catalogId</code>
	 * @deprecated Use {@link CatalogVersionService#getSessionCatalogVersionForCatalog(String)}
	 */
	@Deprecated
