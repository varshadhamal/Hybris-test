...
public interface OrderDao
{
	 ...
	 * 
	 * @deprecated use {@link #findEntriesByNumber(AbstractOrderModel, int)}
	 */
	@Deprecated
	 ...
	 * @return List of matching order entries, or {@link Collections#EMPTY_LIST} in case if no entries were found.
	 * 
	 * @deprecated use {@link #findEntriesByNumber(AbstractOrderModel, int, int)}
	 */
	@Deprecated
	 ...
	 * @return List of matching order entries, or {@link Collections#EMPTY_LIST} in case if no entries were found.
	 * 
	 * @deprecated use {@link #findEntriesByProduct(AbstractOrderModel, ProductModel)}
	 */
	@Deprecated
