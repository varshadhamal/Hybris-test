...
public interface CartService extends AbstractOrderService<CartModel, CartEntryModel>
{
	 ...
	 * 
	 * @deprecated Use {@link AbstractOrderService#addNewEntry(AbstractOrderModel, ProductModel, long, UnitModel)} from
	...
	/**
	 * @deprecated use {@link #hasSessionCart()}
	 */
	@Deprecated
	boolean hasCart();
	 ...
	 * 
	 * @deprecated Use {@link CalculationService#calculate(AbstractOrderModel)} to calculate carts.
	 */
	@Deprecated
	 ...
	 * @deprecated Update cart entries quantities directly via {@link CartEntryModel#setQuantity(Long)} or use
