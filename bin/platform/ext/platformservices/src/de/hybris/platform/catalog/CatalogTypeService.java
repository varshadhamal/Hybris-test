...
public interface CatalogTypeService
{
	 ...
	 * @deprecated Use {@link #isCatalogVersionAwareType(String)} instead.
	 */
	@Deprecated
	 ...
	 *            </ul>
	 * @deprecated Use {@link #getCatalogVersionAwareModel(CatalogVersionModel, String, Map)} instead. It allows you to
