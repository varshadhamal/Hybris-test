...
{
	/**
	 * @deprecated as of release 4.3, please use {@link #getProductForCode(String)}
	 * 
	...
	/**
	 * @deprecated as of release 4.3, TODO: please provide information where there is replacement
	 * 
	...
	/**
	 * 
	 * @deprecated as of release 4.3, please use {@link de.hybris.platform.product.UnitService#getUnitForCode(String)}
	...
	/**
	 * @deprecated as of release 4.3, please use {@link ProductService#getProductsForCategory(CategoryModel)} Returns all
	...
	/**
	 * @deprecated as of release 4.3, please use {@link ProductService#getProductsForCategory(CategoryModel, int, int)}
	 * 
