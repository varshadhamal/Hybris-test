...
public class ComposedTypeTest extends HybrisJUnit4TransactionalTest
{
	...
	public void testSortedSearch() throws Exception
	{
		...
		//bullshit: muss ja nicht: wenn z.b. catalog installiert ist, dann 
		//ist AbstractClassificationIrgendwasStep vorne... dummer test.
		//assertEquals( "AbstractOrder", ( (ComposedType)result.getResult().iterator().next() ).getCode() );
	}
