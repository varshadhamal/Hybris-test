 ...
 */
@IntegrationTest
public class HJMPOptimisticConcurrencyTest extends HybrisJUnit4Test
{
	private static final String CFG_KEY = "hjmp.throw.concurrent.modification.exceptions";

	@Test
	public void testMissingUpdateProblemCheckEnabled() throws JaloBusinessException, InterruptedException
	{
	...
	@Test
	// PLA-10894
	public void testMissingUpdateProblemCheckDisabled() throws JaloBusinessException, InterruptedException
	{
		Boolean previous = null;
		try
		{
