...
public class PrefetchAllModelConverter extends ItemModelConverter
{
	...
	public PrefetchAllModelConverter(final ModelService modelService, final I18NService i18nService, final CommonI18NService commonI18NService, final String type, final Class<? extends AbstractItemModel> modelClass, final SerializationStrategy serializationStrategy, final SourceTransformer sourceTransformer, final SelfHealingService selfHealingService)
	{
